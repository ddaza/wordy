...
final class LibraryModel {
    ...
    func showSample() {
        ...
        let segments = [
            ...
            TranscriptSegment(start: 26, end: 38, text: "Local transcription keeps lecture audio on your Mac by default. Advanced Mode cloud jobs always require an explicit choice."),
