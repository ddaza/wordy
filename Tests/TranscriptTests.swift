...
@Test func captionsUseHalfOpenIntervalsAndPreserveSilence() throws {
...
@Test func adjacentCaptionsAndNonsequentialSeeks() throws {
...
@Test func rejectsInvalidOrAmbiguousTimelines() {
    for segment in [
...
@Test func searchFindsPhrasesAcrossCaptionsAndMapsOriginalTime() {
...
@Test func searchHandlesUnicodeAndDeduplicatesPassages() {
...
@Test func cloudRequiresExplicitConsentAndLocalIsDefault() throws {
    ...
    #expect(throws: TranscriptionRequest.RequestError.self) {
        try TranscriptionRequest(audioURL: URL(string: "https://example.com/audio.wav")!)
    }
}
