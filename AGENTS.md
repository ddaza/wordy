...
- Distinguish preparing a release artifact from publishing it: `make release` writes local DMGs; `make push-release` re-verifies them and publishes with `gh`. Follow the user's authorized release scope.
